...
const PROGRAMS = [
  {
    ...
    tagline: "Concierge-accompanied premium K-beauty journey.",
    description: "A fully curated premium route where a concierge accompanies you throughout the day. Free services include 퍼스널 올리브영 쇼핑 서비스 and 픽업앤드랍오프 서비스.",
    includes: [
      "컨시어지 동행 서비스",
      "무료 서비스: 퍼스널 올리브영 쇼핑 서비스",
      "무료 서비스: 픽업앤드랍오프 서비스",
      "Program coordination and on-site guidance"
    ],
    steps: [
      "Goal and route planning",
      "Concierge-accompanied appointments",
      "Shopping and transfer support"
    ],
    addons: [],
    faq: [
      { q: "Who is this best for?", a: "Guests who want a smooth, one-day premium experience with direct concierge accompaniment." }
    ]
  },
  {
...
function renderFaqPage() {
  ...
  const faq = [
    ...
    },
    {
      ...
      a: "Yes. Starter consultation begins at $10~, and you can upgrade to premium programs later."
    },
    {
